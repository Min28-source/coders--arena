...
export namespace Prisma {
  ...
  */
  ...
  export type ProblemsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "description" | "constraints" | "examples" | "starterCode", ExtArgs["result"]["problems"]>
  ...
  interface ProblemsFieldRefs {
    ...
    readonly examples: FieldRef<"Problems", 'String'>
    readonly starterCode: FieldRef<"Problems", 'Json'>
  }
  ...
  export type ProblemsWhereInput = {
    ...
    constraints?: StringNullableListFilter<"Problems">
    examples?: StringFilter<"Problems"> | string
    starterCode?: JsonFilter<"Problems">
  }
  ...
  export type ProblemsScalarWhereWithAggregatesInput = {
    ...
    constraints?: StringNullableListFilter<"Problems">
    examples?: StringWithAggregatesFilter<"Problems"> | string
    starterCode?: JsonWithAggregatesFilter<"Problems">
  }

  export type ProblemsCreateInput = {
    title: string
    description: string
    constraints?: ProblemsCreateconstraintsInput | string[]
    examples: string
  ...
  export type ProblemsUpdateInput = {
    ...
    constraints?: ProblemsUpdateconstraintsInput | string[]
